...
#
# Usage:  make_pO_datacards.sh <Wfile> <Zfile> <outdir> [disc]
#   disc (optional, default met): met | leppt | leppt_mt40 -- only labels the
#   generated cards' comments; the card structure is discriminant-agnostic
#   (region names + template roles are identical in all three input files,
#   and qcd_norm stays free for all of them -- 2026-07-30 decision).
...
# Auto-generated by make_pO_datacards.sh -- W region '${R}', ${DISCLABEL} discriminant.
imax 1
jmax 4
kmax *
------------
...
# Auto-generated -- simultaneous W('${WDIR}', ${DISCLABEL} discriminant) + Z(incl) fit, two-parameter model.
imax 2
jmax *
kmax *
------------
...
echo "[make_pO_datacards] wrote ${n} datacards to ${OUTDIR} (W discriminant: ${DISCLABEL})"
